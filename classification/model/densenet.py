...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        #self.features2 = self.features.add_module('norm5', nn.BatchNorm2d(num_features))
        # Linear layer
    ...
    def forward(self, x1, x2):
        ...
        out2 = F.relu(features2, inplace=True)
        out1 = F.adaptive_avg_pool2d(out1, (1, 1)).view(features1.size(0), -1)
        out2 = F.adaptive_avg_pool2d(out2, (1, 1)).view(features2.size(0), -1)
